...
If you discover a security vulnerability in Octarq, please report it responsibly.
...
Octarq implements defense-in-depth with the following security controls:
