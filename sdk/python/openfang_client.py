"""
Octarq Python Client — REST API client for controlling Octarq remotely.

Usage:

    from openfang_client import Octarq

    client = Octarq("http://localhost:3000")
...
Note: This is the REST API *client* library.
      For writing Python agents that run inside Octarq, see openfang_sdk.py instead.
"""
...
class _Resource:
    def __init__(self, client: "Octarq"):
        self._c = client


class Octarq:
    """Octarq REST API client. Zero dependencies — uses only stdlib urllib."""
    ...
    def _request(self, method: str, path: str, body: Any = None) -> Any:
        ...
        try:
            ...
            raise OctarqError(f"HTTP {e.code}: {body_text}", e.code, body_text) from e
